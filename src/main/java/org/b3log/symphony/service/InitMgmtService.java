...
public class InitMgmtService {
    ...
    static { // Init built-in roles' permissions, see ${servePath}/issues/358 for more details
        // Visitor
    ...
    public void initSym() {
        ...
        try {
            ...
            tag.put(Tag.TAG_DESCRIPTION, "[Sym](${servePath}) 是一个用 [Java] 实现的现代化社区（论坛/社交网络/博客）平台，“下一代的社区系统，为未来而构建”。");
            tagMgmtService.updateTag(tagId, tag);
            ...
            tag.put(Tag.TAG_DESCRIPTION, "[B3log](http://b3log.org) 是一个开源组织，名字来源于“Bulletin Board Blog”缩写，目标是将独立博客与论坛结合，形成一种新的网络社区体验，详细请看 [B3log 构思](${servePath}/b3log)。目前 B3log 已经开源了多款产品： [Solo] 、 [Sym] 、 [Wide] 。");
            tagMgmtService.updateTag(tagId, tag);
