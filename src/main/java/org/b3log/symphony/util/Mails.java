...
public final class Mails {
    ...
    private static void aliSendHtml(String aliyunFrom, String fromName, String subject, String toMail, String html,
			String aliyunAccesskey, String aliyunAccesssecret) {
    	System.out.println(html);
//    	SendmailUtil send = new SendmailUtil();
//    	send.doSendHtmlEmail(subject, html, toMail);
     ...
     */
    private static void aliSendHtml1(final String sendMail, final String fromName, final String subject, final String toMail,
