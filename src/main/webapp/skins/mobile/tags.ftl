                ...
                <div class="side">
                    ...
                    <div class="module">
                        <div class="module-header">
                            <h2>
                                ${sponsorLabel} 
                                <a href="${servePath}/article/1460083956075" class="fn-right ft-13 ft-gray" target="_blank">${wantPutOnLabel}</a>
                            </h2>
                        </div>
                    ...
                    <div class="module">
                        ...
                        <div class="module-panel">
                            <ul class="module-list open-source">
                                ...
                                <li class="last">
                                    <a target="_blank" href="${servePath}"> <b class="ft-green slogan">【Sym】</b></a>
                                    <a class="title" target="_blank" href="${servePath}"> 黑客与画家的社区</a>
                                </li>
                            </ul>
                        </div>
                    </div>
