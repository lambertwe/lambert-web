<div class="footer">
    <div class="wrapper">
        <div class="slogan">
            ${indexIntroLabel} &nbsp; &nbsp;
            <a href="${servePath}" target="_blank" class="tooltipped tooltipped-n" aria-label="${siteCodeLabel}">
        ...
        <div class="fn-flex-1">
            <div class="footer-nav fn-clear">
                ...
                <a href="${servePath}/article/1457158841475">API</a>
                ...
                <div class="fn-right">
                   ...
                   <a rel="copyright" href="#" >hacpai.com</a>
                    ${visionLabel}</div>
            </div>
            <div class="fn-clear ft-smaller ft-fade">
                       ${sloganLabel}
                    <div class="fn-right">
                       Powered by <a href="#" class="ft-gray">B3log 开源</a> •
                            <a href="#">Sym</a>
